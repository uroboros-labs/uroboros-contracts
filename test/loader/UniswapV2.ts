...
describe("UniswapV2", () => {
	...
	it("works", async () => {
		...
		expect(data.reserve0).eq("9999000000000000000")
		expect(data.reserve1).eq("9999000000000000000")
		expect(data.swap).eq(30)
		expect(data.buy0).eq(301)
		expect(data.sell0).eq(701)
		expect(data.buy1).eq(1)
		expect(data.sell1).eq(101)
	})
})
